package br.com.estruturais.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.estruturais.command.alexa.before.lights.PhillipsHueLight;
import br.com.estruturais.command.alexa.before.lights.XiaomiLight;
